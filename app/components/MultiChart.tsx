...
const MultiChart = ({ data, chartDate }: { data: AllCoinChartData; chartDate: string | undefined }) => {
  ...
  return (
    <div>
      <div className="relative flex flex-col justify-center items-center xl:hidden bg-purple-secondary dark:bg-purple-secondary-dark mx-10 my-5 px-5 py-3 md:p-10 rounded-lg h-[30vh] min-h-72">
